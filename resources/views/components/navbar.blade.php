<nav class="navbar aplus-bg-dark-blue text-white sticky-top">
    <div class="container-fluid">
        ...
        <div class="d-flex ms-auto me-3 gap-4">
            ...
            <a class="nav-link" title="Log out" href="/login"><i class="bi bi-box-arrow-left fs-3 text-white"></i></a>
            <a class="nav-link" title="Acoount" href=""><i class="bi bi-person-circle fs-3 text-white"></i></a>
